...
namespace DddInPractice.Tests
{
    public class MoneySpecs
    {
        ...
        [Fact]
        public void Two_money_instances_are_not_equal_if_they_contain_different_money_amount()
        {
            Money oneDollar = new Money(0, 0, 0, 1, 0, 0);
            Money oneHundredCents = new Money(100, 0, 0, 0, 0, 0);

            oneDollar.Should().NotBe(oneHundredCents);
            oneDollar.GetHashCode().Should().NotBe(oneHundredCents.GetHashCode());
        }
